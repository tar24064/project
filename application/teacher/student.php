    <?php 
      ...
      $course = $conn->query("SELECT a.enroll_id,a.student_id,d.full_name,a.code_id,b.name,c.Teacher_id,c.fullname,b.term
                                            ...
                                            where b.teacher_id = '".$_SESSION["Teacher_id"]."' and a.code_id = '".$_GET['class']."'");
      ...
      if (isset($_POST['submit'])) {
        ...
        <script type='text/javascript'>window.location='student.php?class=<?php echo $rc; ?>';</script>
      <?php }
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                    $add = $conn->query("SELECT * FROM `course`");
